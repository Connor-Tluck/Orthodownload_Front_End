            ...
            if self.project_number.text() == 'Your API Key Here':
                ...
                if selected_content == 'OrthoImagery':
                    ...
                    try:
                        ...
                        print(f'Imagery was downloaded in {download_processing_time} minutes, this will be saved to DB.')
                    except Exception as e:
                    ...
                    try:
                        ...
                        for directory in lowest_dirs:
                            for root, dirs, files in os.walk(directory):
                                if len(files) != 0:
                                    ...
                                    database_storage_json['coverage_binary'] = 0 #not full coverage set flag to 0.
                        ...
                        print(f'Imagery was Reprojected in {reproject_processing_time} minutes, this will be saved to DB.')
                    except Exception as e:
                        mongo_connector(mongo_user=mongo_user, mongo_pass=mongo_pass, collection_name=collection_name,
                                        geometry_data_request=database_storage_json, error_code=e)
                ...
                print(f'Data Download Complete, Writing to Customer Database....Time to Process was:{total_processing_time} minutes')
                ...
                if database_storage_json['coverage_binary'] == 1: #data was coveraged
                    ...
                    mongo_connector(mongo_user=mongo_user,mongo_pass=mongo_pass, collection_name=collection_name, geometry_data_request=database_storage_json, error_code = 'Coverage Gaps Found, No Data Returned.')
